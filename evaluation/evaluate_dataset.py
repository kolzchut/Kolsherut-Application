...
from evaluation.clients.retrieval_client import fetch_retrieval_result
...
def evaluate_single_example(example: Example, scraped: ScrapedPage) -> QueryEvaluation:
    return evaluate_query(example, fetch_retrieval_result(example.query), scraped.service_names)
