...
const getResultsFromServer = async (searchQuery: string, isFast: boolean, responseId: string, situationId: string) => {
...
const fetchResults = async ({searchQuery = "", responseId = "", situationId = "", isFast}: {
    searchQuery?: string,
    responseId?: string,
    situationId?: string,
    isFast: boolean
}) => {
    const fetchedResults = await getResultsFromServer(searchQuery, isFast, responseId, situationId);
