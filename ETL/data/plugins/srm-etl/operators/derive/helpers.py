...
def preprocess_branches(validate=False):
    select_fields = [
        'key', 'id', 'source', 'status', 'name', 'organization', 'operating_unit', 'location', 'address', 'address_details', 'description', 'phone_numbers', 'email_address', 'urls', 'manual_url', 'fixes', 'situations', 'services', 'last_modified'
    ]
    return DF.Flow(
