...
from app.routes.reindex_services_route import reindex_services_router
from app.routes.retrieve_route import retrieve_router
from app.routes.update_service_route import update_service_router
...
app.include_router(reindex_services_router)
